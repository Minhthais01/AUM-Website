...
@Component({
  selector: 'app-manager-chart-after',
  templateUrl: './manager-chart-after.component.html',
  styleUrls: ['./manager-chart-after.component.css']
})
export class ManagerChartAfterComponent {
//Color
red: string = '#ff014fff';
white: string = 'white'
//Button
...
RadarChart(){
  ...
  onPage(){
    this.router.navigate(['/View-ManagerAfterClosing']);
  }
